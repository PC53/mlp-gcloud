...
class ExperimentBuilder(nn.Module):
    def __init__(self, network_model, experiment_name, num_epochs, train_data, val_data,
        ...
        :param learning_rate : a float indicating learning rate in Adam optimizer
    ...
    def plot_func_def(self,all_grads, layers):
        ...
        """
        plt.plot([grad.cpu().numpy() for grad in all_grads], alpha=0.3, color="b")
    ...
    def plot_grad_flow(self, named_parameters):
        ...
        for name,params in named_parameters:
            ...
            if params.requires_grad and 'batch_norm' not in name and 'bias' not in name:
                ...
                mean_grad = params.grad.abs().mean()
