...
class ConvolutionalProcessingBlockBN(nn.Module):
    ...
    def build_module(self):
        ...
        # BN layer
        self.layer_dict['batch_norm_0'] = nn.BatchNorm2d(num_features=self.num_filters,eps=1e-5,momentum=0.1)
        ...
        # BN layer
        self.layer_dict['batch_norm_1'] = nn.BatchNorm2d(num_features=self.num_filters,eps=1e-5,momentum=0.1)
